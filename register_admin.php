...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $valid_admin_code = "ADMIN2025";
    
    // Validation
    if (empty($name) || empty($email) || empty($password) || empty($admin_code)) {
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            $insert_sql = "INSERT INTO users (name, email, password, role, department) VALUES ('$name', '$email', '$hashed_password', 'admin', 'Administration')";
...
<body>
    <form class="glass-card" method="POST">
        ...
        <div class="info-box">
            ⚠️ Admin registration requires a valid registration code. Contact system administrator for access.
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input type="email" class="form-input" name="email" placeholder="admin@example.com" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input type="text" class="form-input" name="admin_code" placeholder="Enter admin code" required>
            </div>
        </div>
        ...
        <a href="login_admin.php" class="login-link">Already have an account? Login here</a>
    </form>
</body>
</html>
